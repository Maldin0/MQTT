        ...
        <Accordion type="multiple" className="w-full">
                ...
                <AccordionContent>
                    <div className="grid grid-cols-9 gap-4 p-4">
                        ...
                        <div className="col-span-1">
                            ...
                            <Select
                                value={lwtQos.toString()}
                                onValueChange={(e) => setLwtQos(e as unknown as QoS.QoS)}
                            >
                                <SelectTrigger>
                        ...
                        <div className="col-span-1">
                            ...
                            <Input
                                ...
                                id="lwtRetain"
                                checked={lwtRetain}
                                onChange={(e) => setLwtRetain(e.target.checked)}
                            />
                        </div>
                        <div className="col-span-9">
                            ...
                            <Textarea
                                id="lwtMessage"
                                value={lwtMessage}
                                onChange={(e) => setLwtMessage(e.target.value)}
                            />
                        </div>
                    </div>
                </AccordionContent>
            ...
            {isConnected && (
                ...
                >
                    <Alert
                        variant="default"
                        className="mt-4 bg-green-100 border border-green-400 text-green-700"
                    >
